            ...
            <nav className='cart-nav'>
                <ul className="cart-ul">
                    ...
                    <button onClick={this.props.cartClear} type="button" className="empty-cart">Reset The Cart</button>
                    {
                        ...
                        :
                        <button disabled style={{backgroundColor: "transparent" , color: 'ivory', border: '1px solid ivory', opacity: '0.5'}} onClick={this.props.goToWishList} type="button" className="wishlist">Wish-List</button>
                    }
